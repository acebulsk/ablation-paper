...
# explore time induced unloading probability ---- 
...
ggplot(prob_unl_df, aes(time_elapsed_bin_labs, prob_unl)) +
  geom_point() +
  labs(y = 'Probability of Unloading + Drip (-)',
       x = x_lab) #+
# scale_color_viridis_c(option = 'magma') +
# labs(colour = 'Air Temperature (°C)')

ggsave('figs/results/probability_of_unloading_w_time.png', width = 4.5, height = 3)
