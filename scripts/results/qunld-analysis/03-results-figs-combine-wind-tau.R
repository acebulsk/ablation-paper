...
# combine stats ---- 
wind_stats <- readRDS('data/results/modelled_wind_unloading_error_table.rds') |> rename(Wind = Value) 
tau_stats <- readRDS('data/results/modelled_tau_unloading_error_table.rds') |> rename(`Shear Stress` = Value)
...
ggsave(
  'figs/results/modelled_tau_wind_unloading_w_obs_long.png',
  # 'figs/final/figure5.png',
  width = 5,
  height = 5,
  device = png
